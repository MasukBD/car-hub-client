    ...
    return (
        <div className="carousel w-full">
            <div id="slide1" className="carousel-item relative w-full">
                ...
                <div className="absolute lg:right-0 flex items-center justify-end h-full lg:bg-gradient-to-l from-[#151515] to-[rgba(21, 21, 21, 0.00)] bg-gradient-to-r from-[#151515] to-[rgba(21, 21, 21, 0.00)]">
                    <div className='w-full lg:w-1/2 space-y-7 pl-5 text-white'>
                ...
                <div className="absolute flex justify-end gap-4 transform -translate-y-1/2 right-10 bottom-5">
            ...
            <div id="slide3" className="carousel-item relative w-full">
                ...
                <div className="absolute lg:left-0 flex items-center justify-start h-full bg-gradient-to-r from-[#151515] to-[rgba(21, 21, 21, 0.00)]">
                    <div className='w-full lg:w-1/2 space-y-7 pl-5 text-white'>
                        <h1 className='lg:text-6xl text-3xl font-bold'>Affordable Price For Car Servicing</h1>
                        <p>There are many variations of passages of  available, but the majority have suffered alteration in some form!</p>
                        <div className='flex gap-7'>
